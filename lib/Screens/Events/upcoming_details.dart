...
class UpcomingDetails extends StatefulWidget {
  const UpcomingDetails({Key? key, this.id}) : super(key: key);
  final dynamic id;
            ...
            children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: Designs.yellowTheme, borderRadius: BorderRadius.circular(6.r),
                        ),
                        child: Center(
                          child: Text('Pending', style: TextStyle(fontSize: 14.sp, fontWeight: FontWeight.w400,
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Center(child: Text('Reschedule Appointment',
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Center(child: Text('Cancel Appointment',
                    style: TextStyle(color: Designs.whiteColor, fontSize: 16.sp, fontWeight: FontWeight.w500),),),
                ),
              ),
            ],
