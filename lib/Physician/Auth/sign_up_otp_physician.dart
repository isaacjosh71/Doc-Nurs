...
import '../../services/physician model/signUPOtp_model.dart';

class SignUpPhysicianOtp extends StatefulWidget {
  const SignUpPhysicianOtp({Key? key, this.phoneNo}) : super(key: key);
  final dynamic phoneNo;

  @override
  State<SignUpPhysicianOtp> createState() => _SignUpPhysicianOtpState();
}

class _SignUpPhysicianOtpState extends State<SignUpPhysicianOtp> {
                    ...
                    onPressed: (){
                      try {
                        ...
                        if(code.isEmpty){Get.snackbar('OTP code', 'Please type in otp code');}
                          ...
                          OtpPhysBody otpPhysBody = OtpPhysBody(
                            otpCode: code,
                            phone: phone,
                          );
