import 'dart:convert';
import 'package:docs_and_nurs/Physician/Auth/sign_up_otp_physician.dart';
...
import '../../Patient Authentications/create_account_option.dart';

class CreatePhysicianAccount extends StatefulWidget {
  const CreatePhysicianAccount({Key? key}) : super(key: key);

  @override
  State<CreatePhysicianAccount> createState() => _CreatePhysicianAccountState();
}

class _CreatePhysicianAccountState extends State<CreatePhysicianAccount> {
      ...
      _onPressed=(){
        try {
          ...
          if(name.isEmpty){Get.snackbar('Name', 'Please type in your name');}
            ...
            SignUpPhysBody signUpPhysBody = SignUpPhysBody(
              name: name,
              phone: phone,
              mail: mail,
              password: password,
