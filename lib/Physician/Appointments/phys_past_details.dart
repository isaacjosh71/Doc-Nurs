...
class PhysicianPastDetails extends StatefulWidget {
  const PhysicianPastDetails({Key? key, this.id}) : super(key: key);
  final dynamic id;

  @override
  State<PhysicianPastDetails> createState() => _PhysicianPastDetailsState();
}

class _PhysicianPastDetailsState extends State<PhysicianPastDetails> {
  @override
