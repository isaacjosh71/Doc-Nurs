...
import 'package:docs_and_nurs/Physician/Appointments/phys_past_details.dart';
...
class PhysicianPastList extends StatefulWidget {
  const PhysicianPastList({Key? key}) : super(key: key);

  @override
  State<PhysicianPastList> createState() => _PhysicianPastListState();
}

class _PhysicianPastListState extends State<PhysicianPastList> {
  @override
