...
class PhysicianAccountProfile extends StatefulWidget {
  const PhysicianAccountProfile({Key? key}) : super(key: key);

  @override
  State<PhysicianAccountProfile> createState() => _PhysicianAccountProfileState();
}

class _PhysicianAccountProfileState extends State<PhysicianAccountProfile> {
  @override
  void initState() {
    super.initState();
    loadImage();
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextField(
                  enabled: false,
                  decoration: InputDecoration(
                      hintText: 'joshuaosazuwa@gmail.com',
                      hintStyle: TextStyle(
                          color: const Color(0xFF1F1F1F), fontSize: 15.sp,
                          fontWeight: FontWeight.w400, fontStyle: FontStyle.normal
                      )),
